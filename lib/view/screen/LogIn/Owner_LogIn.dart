...
import 'package:eventa_project/view/screen/SignUp/Owner_Signup.dart';
                  ...
                  child: SingleChildScrollView(
                    child: Form(
                      ...
                      child: Column(
                        children: <Widget>[
                          const SizedBox(
                              height: 80), // يمكنك تعديل المسافة حسب الحاجة
                          const SizedBox(
                            height: 100,
                            width: 200,
                            child: Image(
                          ...
                          const SizedBox(
                              height: 60), // يمكنك تعديل المسافة حسب الحاجة
                          const Align(
                            alignment:
